...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostActionInputsError {
    Status400(models::JsonErrorResponseNull),
    Status401(models::JsonErrorResponseNull),
    Status403(models::JsonErrorResponseNull),
    Status404(models::JsonErrorResponseNull),
...
pub async fn cancel_workflow(
    ...
    let uri_str = format!(
        "{}/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_id}/cancel",
        configuration.base_path,
        repo_ref = crate::apis::urlencode(p_path_repo_ref),
        action_identifier = crate::apis::urlencode(p_path_action_identifier),
...
pub async fn delete_workflow(
    ...
    let uri_str = format!(
        "{}/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_id}",
        configuration.base_path,
        repo_ref = crate::apis::urlencode(p_path_repo_ref),
        action_identifier = crate::apis::urlencode(p_path_action_identifier),
        workflow_id = p_path_workflow_id
...
pub async fn get_action_inputs(
    configuration: &configuration::Configuration,
    repo_ref: &str,
    action_identifier: &str,
) -> Result<Vec<Vec<serde_json::Value>>, Error<GetActionInputsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_ref = repo_ref;
    let p_path_action_identifier = action_identifier;

    let uri_str = format!(
        "{}/repos/{repo_ref}/+/actions/{action_identifier}/inputs",
        configuration.base_path,
        repo_ref = crate::apis::urlencode(p_path_repo_ref),
        action_identifier = crate::apis::urlencode(p_path_action_identifier)
    );
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;Vec&lt;serde_json::Value&gt;&gt;`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;Vec&lt;serde_json::Value&gt;&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetActionInputsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn patch_action(
    ...
    let p_path_repo_ref = repo_ref;
    let p_path_action_identifier = action_identifier;
    let p_body_action_update_input = action_update_input;
    ...
    req_builder = req_builder.json(&p_body_action_update_input);
...
pub async fn patch_stage(
    ...
    let p_path_workflow_id = workflow_id;
    let p_path_stage_number = stage_number;
    let p_body_stage_update_input = stage_update_input;

    let uri_str = format!("{}/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_id}/stages/{stage_number}", configuration.base_path, repo_ref=crate::apis::urlencode(p_path_repo_ref), action_identifier=crate::apis::urlencode(p_path_action_identifier), workflow_id=p_path_workflow_id, stage_number=p_path_stage_number);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::PATCH, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_stage_update_input);
...
pub async fn patch_step(
    ...
    let p_path_stage_number = stage_number;
    let p_path_step_number = step_number;
    let p_body_step_update_input = step_update_input;
    ...
    req_builder = req_builder.json(&p_body_step_update_input);
...
pub async fn patch_workflow(
    ...
    let p_path_action_identifier = action_identifier;
    let p_path_workflow_id = workflow_id;
    let p_body_workflow_update_input = workflow_update_input;
    ...
    req_builder = req_builder.json(&p_body_workflow_update_input);
...
pub async fn post_action(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_ref = repo_ref;
    let p_body_action_create_input = action_create_input;
    ...
    req_builder = req_builder.json(&p_body_action_create_input);
...
pub async fn post_action_inputs(
    configuration: &configuration::Configuration,
    repo_ref: &str,
    action_identifier: &str,
    request_body: std::collections::HashMap<String, serde_json::Value>,
) -> Result<(), Error<PostActionInputsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_ref = repo_ref;
    let p_path_action_identifier = action_identifier;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostActionInputsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn post_step(
    ...
    let p_path_workflow_id = workflow_id;
    let p_path_stage_number = stage_number;
    let p_body_step_create_input = step_create_input;
    ...
    req_builder = req_builder.json(&p_body_step_create_input);
...
pub async fn post_step_log(
    ...
    req_builder = req_builder.json(&p_body_live_log_line);
...
pub async fn rerun_workflow(
    ...
    action_identifier: &str,
    workflow_id: i64,
    workflow_rerun_input: models::WorkflowRerunInput,
) -> Result<(), Error<RerunWorkflowError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_ref = repo_ref;
    let p_path_action_identifier = action_identifier;
    let p_path_workflow_id = workflow_id;
    let p_body_workflow_rerun_input = workflow_rerun_input;

    let uri_str = format!(
        "{}/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_id}/rerun",
        configuration.base_path,
        repo_ref = crate::apis::urlencode(p_path_repo_ref),
        action_identifier = crate::apis::urlencode(p_path_action_identifier),
        workflow_id = p_path_workflow_id
    ...
    req_builder = req_builder.json(&p_body_workflow_rerun_input);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RerunWorkflowError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
