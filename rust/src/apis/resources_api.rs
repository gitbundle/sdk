...
pub async fn get_gitignores(configuration: &configuration::Configuration, ) -> Result<Vec<String>, Error<GetGitignoresError>> {
...
pub async fn get_licenses(configuration: &configuration::Configuration, ) -> Result<Vec<models::License>, Error<GetLicensesError>> {
