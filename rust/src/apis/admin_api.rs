...
pub async fn delete_group(configuration: &configuration::Configuration, group_ref: &str) -> Result<(), Error<DeleteGroupError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_ref = group_ref;

    let uri_str = format!("{}/admin/groups/{group_ref}", configuration.base_path, group_ref=crate::apis::urlencode(p_group_ref));
...
pub async fn delete_user(configuration: &configuration::Configuration, user_identifier: &str) -> Result<(), Error<DeleteUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_identifier = user_identifier;

    let uri_str = format!("{}/admin/users/{user_identifier}", configuration.base_path, user_identifier=crate::apis::urlencode(p_user_identifier));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_variable(configuration: &configuration::Configuration, variable_identifier: &str) -> Result<(), Error<DeleteVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_variable_identifier = variable_identifier;

    let uri_str = format!("{}/admin/variables/{variable_identifier}", configuration.base_path, variable_identifier=crate::apis::urlencode(p_variable_identifier));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_groups(configuration: &configuration::Configuration, page: Option<i64>, size: Option<i64>, query: Option<&str>, sort: Option<models::GroupSort>, order: Option<models::OrderOption>) -> Result<Vec<models::GroupModel>, Error<GetGroupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_page = page;
    let p_size = size;
    let p_query = query;
...
pub async fn get_runners(configuration: &configuration::Configuration, page: Option<i64>, size: Option<i64>, query: Option<&str>) -> Result<Vec<models::RunnerCreator>, Error<GetRunnersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_page = page;
    let p_size = size;
    let p_query = query;
...
pub async fn get_stats(configuration: &configuration::Configuration, ) -> Result<models::AdminStats, Error<GetStatsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AdminStats`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AdminStats`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_user(configuration: &configuration::Configuration, user_identifier: &str) -> Result<models::UserModel, Error<GetUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_identifier = user_identifier;
...
pub async fn get_users(configuration: &configuration::Configuration, page: Option<i64>, size: Option<i64>, query: Option<&str>, order: Option<models::OrderOption>, sort: Option<models::UserSort>) -> Result<Vec<models::UserModel>, Error<GetUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_page = page;
    let p_size = size;
    let p_query = query;
...
pub async fn get_variable(configuration: &configuration::Configuration, variable_identifier: &str) -> Result<models::VariableModel, Error<GetVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_variable_identifier = variable_identifier;
...
pub async fn get_variables(configuration: &configuration::Configuration, page: Option<i64>, size: Option<i64>, query: Option<&str>, types: Option<Vec<models::VariableType>>, sort: Option<models::VariableSort>, order: Option<models::OrderOption>) -> Result<Vec<models::VariableGroup>, Error<GetVariablesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_page = page;
    let p_size = size;
    let p_query = query;
...
pub async fn patch_user(configuration: &configuration::Configuration, user_identifier: &str, user_patch_input: models::UserPatchInput) -> Result<models::UserModel, Error<PatchUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_identifier = user_identifier;
...
pub async fn patch_user_admin(configuration: &configuration::Configuration, user_identifier: &str, admin_patch_input: models::AdminPatchInput) -> Result<models::UserModel, Error<PatchUserAdminError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_identifier = user_identifier;
    let p_admin_patch_input = admin_patch_input;

    let uri_str = format!("{}/admin/users/{user_identifier}/admin", configuration.base_path, user_identifier=crate::apis::urlencode(p_user_identifier));
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
...
pub async fn patch_variable(configuration: &configuration::Configuration, variable_identifier: &str, variable_patch_input: models::VariablePatchInput) -> Result<models::VariableModel, Error<PatchVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_variable_identifier = variable_identifier;
...
pub async fn post_user(configuration: &configuration::Configuration, user_create_input: models::UserCreateInput) -> Result<models::UserModel, Error<PostUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn post_variable(configuration: &configuration::Configuration, variable_create_input: models::VariableCreateInput) -> Result<models::VariableModel, Error<PostVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
