...
pub async fn delete_webhook(configuration: &configuration::Configuration, repo_ref: &str, webhook_identifier: &str) -> Result<(), Error<DeleteWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repo_ref = repo_ref;
    let p_webhook_identifier = webhook_identifier;

    let uri_str = format!("{}/repos/{repo_ref}/+/webhooks/{webhook_identifier}", configuration.base_path, repo_ref=crate::apis::urlencode(p_repo_ref), webhook_identifier=crate::apis::urlencode(p_webhook_identifier));
...
pub async fn get_webhook(configuration: &configuration::Configuration, repo_ref: &str, webhook_identifier: &str) -> Result<models::WebhookModel, Error<GetWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repo_ref = repo_ref;
    let p_webhook_identifier = webhook_identifier;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WebhookModel`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WebhookModel`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_webhooks(configuration: &configuration::Configuration, repo_ref: &str, page: Option<i64>, size: Option<i64>, query: Option<&str>, sort: Option<models::WebhookSort>, order: Option<models::OrderOption>) -> Result<Vec<models::WebhookModel>, Error<GetWebhooksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repo_ref = repo_ref;
    let p_page = page;
    let p_size = size;
    ...
    let uri_str = format!("{}/repos/{repo_ref}/+/webhooks", configuration.base_path, repo_ref=crate::apis::urlencode(p_repo_ref));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::WebhookModel&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::WebhookModel&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn patch_webhook(configuration: &configuration::Configuration, repo_ref: &str, webhook_identifier: &str, webhook_patch_input: models::WebhookPatchInput) -> Result<models::WebhookModel, Error<PatchWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repo_ref = repo_ref;
    let p_webhook_identifier = webhook_identifier;
...
pub async fn post_retrigger(configuration: &configuration::Configuration, repo_ref: &str, webhook_identifier: &str, webhook_execution_id: i64) -> Result<models::WebhookExecutionModel, Error<PostRetriggerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repo_ref = repo_ref;
    let p_webhook_identifier = webhook_identifier;
    let p_webhook_execution_id = webhook_execution_id;
...
pub async fn post_webhook(configuration: &configuration::Configuration, repo_ref: &str, webhook_create_input: models::WebhookCreateInput) -> Result<models::WebhookModel, Error<PostWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_repo_ref = repo_ref;
