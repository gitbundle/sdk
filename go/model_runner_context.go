...
func (o *RunnerContext) GetVersion() string {
...
// and a boolean to check if the value has been set.
func (o *RunnerContext) GetVersionOk() (*string, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *RunnerContext) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *RunnerContext) SetVersion(v string) {
	o.Version = &v
}
