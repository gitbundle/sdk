...
*/
func (a *ActionsAPIService) CancelWorkflow(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64) ApiCancelWorkflowRequest {
	return ApiCancelWorkflowRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
func (a *ActionsAPIService) CancelWorkflowExecute(r ApiCancelWorkflowRequest) (*WorkflowStages, *http.Response, error) {
	...
	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_idn}/cancel"
...
*/
func (a *ActionsAPIService) DeleteWorkflow(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64) ApiDeleteWorkflowRequest {
	return ApiDeleteWorkflowRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
func (a *ActionsAPIService) DeleteWorkflowExecute(r ApiDeleteWorkflowRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_idn}"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", url.PathEscape(parameterValueToString(r.repoRef, "repoRef")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"action_identifier"+"}", url.PathEscape(parameterValueToString(r.actionIdentifier, "actionIdentifier")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"workflow_idn"+"}", url.PathEscape(parameterValueToString(r.workflowIdn, "workflowIdn")), -1)
...
type ApiGetActionInputsRequest struct {
	ctx              context.Context
	ApiService       *ActionsAPIService
	repoRef          string
	actionIdentifier string
...
func (r ApiGetActionInputsRequest) Execute() ([][]interface{}, *http.Response, error) {
	return r.ApiService.GetActionInputsExecute(r)
}

/*
GetActionInputs Method for GetActionInputs

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param repoRef Repository id or ref
	@param actionIdentifier Action id or name
	@return ApiGetActionInputsRequest
*/
func (a *ActionsAPIService) GetActionInputs(ctx context.Context, repoRef string, actionIdentifier string) ApiGetActionInputsRequest {
	return ApiGetActionInputsRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
//
//	@return [][]interface{}
func (a *ActionsAPIService) GetActionInputsExecute(r ApiGetActionInputsRequest) ([][]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActionsAPIService.GetActionInputs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/inputs"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", url.PathEscape(parameterValueToString(r.repoRef, "repoRef")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"action_identifier"+"}", url.PathEscape(parameterValueToString(r.actionIdentifier, "actionIdentifier")), -1)
...
*/
func (a *ActionsAPIService) GetStepLogStream(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64, stageNumber int64, stepNumber int64) ApiGetStepLogStreamRequest {
	return ApiGetStepLogStreamRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
*/
func (a *ActionsAPIService) GetStepLogs(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64, stageNumber int64, stepNumber int64) ApiGetStepLogsRequest {
	return ApiGetStepLogsRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
*/
func (a *ActionsAPIService) GetWorkflow(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64) ApiGetWorkflowRequest {
	return ApiGetWorkflowRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
*/
func (a *ActionsAPIService) PatchStage(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64, stageNumber int64) ApiPatchStageRequest {
	return ApiPatchStageRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
func (a *ActionsAPIService) PatchStageExecute(r ApiPatchStageRequest) (*StageModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_idn}/stages/{stage_number}"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", url.PathEscape(parameterValueToString(r.repoRef, "repoRef")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"action_identifier"+"}", url.PathEscape(parameterValueToString(r.actionIdentifier, "actionIdentifier")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"workflow_idn"+"}", url.PathEscape(parameterValueToString(r.workflowIdn, "workflowIdn")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"stage_number"+"}", url.PathEscape(parameterValueToString(r.stageNumber, "stageNumber")), -1)
...
*/
func (a *ActionsAPIService) PatchStep(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64, stageNumber int64, stepNumber int64) ApiPatchStepRequest {
	return ApiPatchStepRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
func (a *ActionsAPIService) PatchStepExecute(r ApiPatchStepRequest) (*StepModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_idn}/stages/{stage_number}/{step_number}"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", url.PathEscape(parameterValueToString(r.repoRef, "repoRef")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"action_identifier"+"}", url.PathEscape(parameterValueToString(r.actionIdentifier, "actionIdentifier")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"workflow_idn"+"}", url.PathEscape(parameterValueToString(r.workflowIdn, "workflowIdn")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"stage_number"+"}", url.PathEscape(parameterValueToString(r.stageNumber, "stageNumber")), -1)
...
*/
func (a *ActionsAPIService) PatchWorkflow(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64) ApiPatchWorkflowRequest {
	return ApiPatchWorkflowRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
type ApiPostActionInputsRequest struct {
	ctx              context.Context
	ApiService       *ActionsAPIService
	repoRef          string
	actionIdentifier string
...
func (r ApiPostActionInputsRequest) RequestBody(requestBody map[string]interface{}) ApiPostActionInputsRequest {
	r.requestBody = &requestBody
	return r
}

func (r ApiPostActionInputsRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostActionInputsExecute(r)
}

/*
PostActionInputs Method for PostActionInputs

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param repoRef Repository id or ref
	@param actionIdentifier Action id or name
	@return ApiPostActionInputsRequest
*/
func (a *ActionsAPIService) PostActionInputs(ctx context.Context, repoRef string, actionIdentifier string) ApiPostActionInputsRequest {
	return ApiPostActionInputsRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
// Execute executes the request
func (a *ActionsAPIService) PostActionInputsExecute(r ApiPostActionInputsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActionsAPIService.PostActionInputs")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ActionsAPIService) PostStep(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64, stageNumber int64) ApiPostStepRequest {
	return ApiPostStepRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
*/
func (a *ActionsAPIService) PostStepLog(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64, stageNumber int64, stepNumber int64) ApiPostStepLogRequest {
	return ApiPostStepLogRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
type ApiRerunWorkflowRequest struct {
	...
	actionIdentifier   string
	workflowIdn        int64
	workflowRerunInput *WorkflowRerunInput
}

func (r ApiRerunWorkflowRequest) WorkflowRerunInput(workflowRerunInput WorkflowRerunInput) ApiRerunWorkflowRequest {
	r.workflowRerunInput = &workflowRerunInput
	return r
}

func (r ApiRerunWorkflowRequest) Execute() (*http.Response, error) {
	return r.ApiService.RerunWorkflowExecute(r)
}

/*
RerunWorkflow Rerun stages in a workflow
...
*/
func (a *ActionsAPIService) RerunWorkflow(ctx context.Context, repoRef string, actionIdentifier string, workflowIdn int64) ApiRerunWorkflowRequest {
	return ApiRerunWorkflowRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
// Execute executes the request
func (a *ActionsAPIService) RerunWorkflowExecute(r ApiRerunWorkflowRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ActionsAPIService.RerunWorkflow")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_idn}/rerun"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", url.PathEscape(parameterValueToString(r.repoRef, "repoRef")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"action_identifier"+"}", url.PathEscape(parameterValueToString(r.actionIdentifier, "actionIdentifier")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"workflow_idn"+"}", url.PathEscape(parameterValueToString(r.workflowIdn, "workflowIdn")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.workflowRerunInput == nil {
		return nil, reportError("workflowRerunInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.workflowRerunInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["access_token_query"]; ok {
