...
func (a *ActionsAPIService) GetStepLogStreamExecute(r ApiGetStepLogStreamRequest) (string, *http.Response, error) {
	...
	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_id}/stages/{stage_number}/{step_number}/logstream"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", url.PathEscape(parameterValueToString(r.repoRef, "repoRef")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"action_identifier"+"}", url.PathEscape(parameterValueToString(r.actionIdentifier, "actionIdentifier")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"workflow_id"+"}", url.PathEscape(parameterValueToString(r.workflowId, "workflowId")), -1)
...
*/
func (a *ActionsAPIService) PostStepLogStream(ctx context.Context, repoRef string, actionIdentifier string, workflowId int64, stageNumber int64, stepNumber int64) ApiPostStepLogStreamRequest {
	return ApiPostStepLogStreamRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
*/
func (a *ActionsAPIService) RerunWorkflow(ctx context.Context, repoRef string, actionIdentifier string, workflowId int64) ApiRerunWorkflowRequest {
	return ApiRerunWorkflowRequest{
		ApiService:       a,
		ctx:              ctx,
		repoRef:          repoRef,
...
func (a *ActionsAPIService) RerunWorkflowExecute(r ApiRerunWorkflowRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/repos/{repo_ref}/+/actions/{action_identifier}/workflows/{workflow_id}/rerun"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", url.PathEscape(parameterValueToString(r.repoRef, "repoRef")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"action_identifier"+"}", url.PathEscape(parameterValueToString(r.actionIdentifier, "actionIdentifier")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"workflow_id"+"}", url.PathEscape(parameterValueToString(r.workflowId, "workflowId")), -1)
