...
func NewUserModel(created int64, email string, id int64, isActive bool, isAdmin bool, isBlocked bool, isEmailVerified bool, name string, type_ UserType, updated int64) *UserModel {
	this := UserModel{}
...
func (o *UserModel) GetIsEmailVerified() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UserModel) GetIsEmailVerifiedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UserModel) SetIsEmailVerified(v bool) {
	o.IsEmailVerified = v
}
