...
func NewWorkflowModel(action string, actionId int64, authorEmail string, authorName string, beforeSha string, context map[string]interface{}, created int64, createdBy int64, cron string, debug bool, deploy string, deployId int64, error_ string, event TriggerEvent, finished int64, id int64, link string, message string, name string, number int64, params map[string]interface{}, repoId int64, started int64, status CIStatus, targetRev string, title string, updated int64, version int64, yamlProvider WorkflowProvider, yamlResolved string) *WorkflowModel {
	this := WorkflowModel{}
	this.Action = action
...
func (o *WorkflowModel) GetInputs() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WorkflowModel) GetInputsOk() (map[string]interface{}, bool) {
...
func (o *WorkflowModel) HasInputs() bool {
	if o != nil && !IsNil(o.Inputs) {
		return true
	}
...
func (o *WorkflowModel) SetInputs(v map[string]interface{}) {
	o.Inputs = v
}
