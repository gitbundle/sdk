...
func (a *BootstrapAPIService) GetBootstrapExecute(r ApiGetBootstrapRequest) (*BootstrapMetadata, *http.Response, error) {
	...
	localVarPath := localBasePath + "/bootstrap/{bootstrap_ref}/+/{path}"
	localVarPath = strings.Replace(localVarPath, "{"+"bootstrap_ref"+"}", url.PathEscape(parameterValueToString(r.bootstrapRef, "bootstrapRef")), -1)
